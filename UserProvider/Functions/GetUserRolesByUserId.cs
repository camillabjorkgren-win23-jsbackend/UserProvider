...
public class GetUserRolesByUserId(ILogger<GetUserRolesByUserId> logger, DataContext context)
{
    private readonly ILogger<GetUserRolesByUserId> _logger = logger;
    private readonly DataContext _context = context;

    [Function("GetUserRolesByUserId")]
